 ...
 *
 * This function cancels all buffer outstanding buffer operations previously
 * scheduled. This means any pending iio_buffer_push() or iio_buffer_refill()
 * operation will abort and return immediately, any further invocations of these
 ...
 * useful to bypass these conditions if the buffer operation stopped due to an
 ...
 * the first invocation will be effectless.
 *
